...
<div class="container form-content mt-5 mb-5 pt-5">
    ...
    <form class="form-container">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="name" placeholder="Boleh dibiarkan kosong">
        </div>

        <!-- Nomor Telepon / Email -->
        <div class="mb-3">
            <label for="contact" class="form-label">Nomor Telepon</label>
            <input type="text" class="form-control" id="contact" placeholder="Jawaban Anda" required>
        </div>

        <!-- Keluhan -->
        <div class="mb-3">
            <label for="complaint" class="form-label">Judul Aduan</label>
            <input type="text" class="form-control" id="complaint" placeholder="Jawaban Anda" required>
        </div>

        <!-- Deskripsi Kejadian -->
        <div class="mb-3">
            <label for="description" class="form-label">Deskripsi Kejadian</label>
            <textarea class="form-control" id="description" placeholder="Ceritakan secara detail" rows="3" required></textarea>
        </div>

        <!-- Lokasi Kejadian -->
        <div class="mb-3">
            <label for="location" class="form-label">Lokasi Kejadian</label>
            <input type="text" class="form-control" id="location" placeholder="Jawaban Anda" required>
        </div>
        ...
        <div class="mb-3">
            ...
            <textarea class="form-control" id="perpetrator" placeholder="Misalnya: tinggi, pakaian, dll." rows="2"></textarea>
        </div>
        ...
        <div class="mb-3">
            ...
            <select class="form-control" id="followup" required>
