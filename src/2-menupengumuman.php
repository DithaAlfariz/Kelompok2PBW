                    ...
                    <div class="col">
                        <a href="5-detailpengumuman.php?id=<?= $row['id']; ?>" style="text-decoration:none;color:inherit;">
                            <div class="announcement-card h-100" style="cursor:pointer; position:relative;">
                                ...
                                <!-- Button edit di kanan bawah -->
                                <a href="4-detailaduan.php?id=<?php echo $row['id_history']; ?>" class="btn-edit" style="position:absolute; right:12px; bottom:12px; z-index:2; color:#000; border-radius:50%; width:36px; height:36px; display:flex; align-items:center; justify-content:center; font-size:18px;">✎</a>
                            </div>
                        </a>
                    </div>
                <?php endwhile; ?>
