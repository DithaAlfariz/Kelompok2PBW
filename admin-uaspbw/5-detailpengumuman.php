...
<h2 class="fw-bold">Kelola Aduan Pengumuman</h2>
<div class="detail-container mt-6">
    ...
    <div style="display: flex; justify-content: space-between; margin-top: 15px;">
        ...
        <button class="btn btn-primary" onclick="konfirmasi()">Konfirmasi</button>
    </div>
    ...
    function previewImage(event) {
        ...
        if (file) {
            ...
            reader.onload = function(e) {
                ...
                uploadedImage.style.display = "block"; // Show image after upload
            };
