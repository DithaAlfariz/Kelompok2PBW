...
<div class="container mb-5 d-flex justify-content-center align-items-center flex-column" style="min-height:220px;">
    <h5 class="fw-bold mb-3 text-center">Statistik Aduan per Kategori</h5>
    <canvas id="kategoriPieChart" width="400" height="200"></canvas>
</div>
<h2 class="judul fw-bold">Kelola Aduan Masuk</h2>
<div class="container tampilan-aduan mb-5">
